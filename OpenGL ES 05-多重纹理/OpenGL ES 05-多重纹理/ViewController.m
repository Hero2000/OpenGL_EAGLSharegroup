...
- (void)viewDidLoad {
    ...
    TextureGenerater *generater = [[TextureGenerater alloc] init];
//    [generater setupCurrentContext:nil];
    [generater setupSharegroup:view.context.sharegroup];
    GLKTextureInfo* info1 = [generater getTextureInfo:@"honeybee"];
